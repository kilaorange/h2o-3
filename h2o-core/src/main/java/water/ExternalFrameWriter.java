...
public class ExternalFrameWriter {
    ...
    public void closeChunks() throws IOException{
        ...
        AutoBuffer confirmAb = new AutoBuffer(channel, false);
        // this needs to be here because confirmAb forces this code to wait
        // for all the work to be done on the recipient side. The assert around it is just additional, not
        // so important check
        ...
        do {
            ...
            switch (requestType) {
                ...
                case ADD_TO_CHUNK: // Add to existing frame
                    ...
                    break;
                case ExternalFrameWriter.CLOSE_NEW_CHUNK: // Close new chunks
