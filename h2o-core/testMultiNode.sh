...
($JVM $TEST_SSL -Dbuild.id=$BUILD_ID -Djob.name=$JOB_NAME -Dgit.commit=$GIT_COMMIT -Dgit.branch=$GIT_BRANCH -Dai.h2o.name=$CLUSTER_NAME -Dai.h2o.baseport=$CLUSTER_BASEPORT -Dai.h2o.ga_opt_out=yes $JACOCO_FLAG $JUNIT_RUNNER $JUNIT_TESTS_BOOT water.rapids.RapidsTest water.rapids.RapidsTest water.rapids.RapidsTest water.rapids.RapidsTest water.rapids.RapidsTest water.rapids.RapidsTest water.rapids.RapidsTest water.rapids.RapidsTest water.rapids.RapidsTest water.rapids.RapidsTest water.rapids.RapidsTest water.rapids.RapidsTest water.rapids.RapidsTest  2>&1 ; echo $? > $OUTDIR/status.0) 1> $OUTDIR/out.0 2>&1
